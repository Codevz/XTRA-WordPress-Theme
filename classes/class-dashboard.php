	...
	public function importer() {
		...
		if ( self::$premium && $demos_count > 9 ) {
			...
			echo '<div class="xtra-filters">';
				...
				echo '<a href="#" data-filter="" class="xtra-filters-all xtra-current">' . esc_html( Codevz_Core_Strings::get( 'all' ) ) . '<span>' . esc_html( $demos_count - ( $this->is_free ? 1 : 0 ) ) . '</span></a>';
